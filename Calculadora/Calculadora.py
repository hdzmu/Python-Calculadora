...
display=Entry(tablero, highlightthickness=1, textvariable=texto) #highlightthickness grosor de borde
...
def digitar(caracter):
    texto.set(texto.get() + caracter)
#Numeros

bt7=Button(tablero, width=10, height=1 ,text="7", command=lambda:digitar("7"))
bt7.config(bg="black", fg="#12ED3E",font=(fuente,20))
bt7.grid(row=2, column=1, padx=5 , pady=5)

bt8=Button(tablero, width=10, height=1 ,text="8", command=lambda:digitar("8"))
bt8.config(bg="black", fg="#12ED3E",font=(fuente,20))
bt8.grid(row=2, column=2, padx=5 , pady=5)

bt9=Button(tablero, width=10, height=1 ,text="9", command=lambda:digitar("9"))
bt9.config(bg="black", fg="#12ED3E",font=(fuente,20))
bt9.grid(row=2, column=3, padx=5 , pady=5)

bt4=Button(tablero, width=10, height=1 ,text="4", command=lambda:digitar("4"))
bt4.config(bg="black", fg="#12ED3E",font=(fuente,20))
bt4.grid(row=3, column=1, padx=5 , pady=5)

bt5=Button(tablero, width=10, height=1 ,text="5", command=lambda:digitar("5"))
bt5.config(bg="black", fg="#12ED3E",font=(fuente,20))
bt5.grid(row=3, column=2, padx=5 , pady=5)

bt6=Button(tablero, width=10, height=1 ,text="6", command=lambda:digitar("6"))
bt6.config(bg="black", fg="#12ED3E",font=(fuente,20))
bt6.grid(row=3, column=3, padx=5 , pady=5)

bt1=Button(tablero, width=10, height=1 ,text="1", command=lambda:digitar("1"))
bt1.config(bg="black", fg="#12ED3E", font=(fuente,20))
bt1.grid(row=4, column=1, padx=5 , pady=5)

bt2=Button(tablero, width=10, height=1 ,text="2", command=lambda:digitar("2"))
...
bt3.config(bg="black", fg="#12ED3E",font=(fuente,20), command=lambda:digitar("3"))
bt3.grid(row=4, column=3, padx=5 , pady=5)

bt0=Button(tablero, width=10, height=1 ,text="0", command=lambda:digitar("0"))
